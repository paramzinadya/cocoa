# Generated by Django 4.2.1 on 2025-06-11 12:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cocoa', '0008_remove_tagpost_filial_post_filial'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='cat',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='cocoa.category', verbose_name='Категории'),
        ),
        migrations.AlterField(
            model_name='post',
            name='content',
        ...
        migrations.AlterField(
            model_name='post',
            name='filial',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Филиал', to='cocoa.filial'),
        ),
        migrations.AlterField(
            model_name='post',
            name='is_published',
